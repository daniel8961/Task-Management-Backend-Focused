...
const createTask = async (req, res) => {
    ...
    try {
        ...
        if (deadline && notificationTimes) {
            scheduleNotification(savedTask._id, 'task', new Date(deadline), notificationTimes);
        }
...
const updateTask = async (req, res) => {
    ...
    try {
        ...
        if (req.body.deadline && req.body.notificationTimes) {
            scheduleNotification(updatedTask._id, 'task', new Date(req.body.deadline), req.body.notification)
        }
